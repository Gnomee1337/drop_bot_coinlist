        ...
        <div class="table-responsive display responsive nowrap ">
            <table class="table table-bordered " id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    $statement = $db->prepare("SELECT `full_name`,`country`,`region`,`city`,`address`,`date_of_birth`,`document_id`,`phone_number`,`tg_username`,`referral_id`,`user_status`,`language`,`id_drop_accs` FROM drop_accs WHERE `user_status` = 'filled' ORDER BY `id_drop_accs`");
